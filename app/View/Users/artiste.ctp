  ...
  <div class="row">
      ...
      <div class="col-xs-6 col-md-4 sidebar">
	     <div class="user_sidebar">
		  <div class="user_side-title">Welcome Dejavu<?//php echo $userinfo['User']['email']; ?></div>
		  <div class="edit"><a href="#" class="btn btn-default">edit</a><span class="profile-edit"> My Fan Page</span></div>
         </div>		  
	  </div>
	  </div>
	  ...
	  <!--<div class="row">
	    <div class="col-xs-12 col-md-8">
	      <div class="player-title">Your Movie History</div>
