...
<div class="filter">
   ...
   <div class='event-span6'>
		...
		<?php  
			...
			echo $this->Form->input('first_name',array('size'=>30, 'maxlength'=>30, 'class'=>'required sign',
				'label' => false, 'placeholder'=>'First name',
			)); 
			
			echo $this->Form->input('last_name',array('size'=>30, 'maxlength'=>30, 'class'=>'required sign',
			...
			echo $this->Form->input('email',array('size'=>30, 'maxlength'=>30, 'class'=>'required sign',
				'label' => false, 'placeholder'=>'Email',
			)); 
			
			echo $this->Form->input('password',array('size'=>30, 'maxlength'=>30, 'class'=>'required sign',
				'label' => false, 'placeholder'=>'Password',
			));

			echo $this->Form->input('password_confirm',array('size'=>30, 'maxlength'=>30, 'class'=>'required sign', 'type'=>'password',
				'label' => false, 'placeholder'=>'Repeat Password',
			)); 			
			
			echo $this->Form->input('group_id', array('type' => 'hidden', 'value'=>4));
		?>
